...
import com.sessac.aibackend.domain.Role;
import com.sessac.aibackend.domain.User;
import com.sessac.aibackend.dto.LoginRequest;
import com.sessac.aibackend.dto.SignupRequest;
import com.sessac.aibackend.error.DuplicateException;
import com.sessac.aibackend.repository.UserRepository;
import com.sessac.aibackend.security.JwtUtil;
...
public class AuthController {
    ...
    @PostMapping("/login")     // -> security 에서 인증 객체를 건드리는 매니저,, -> 인증 객체를 관리하는 매니저 (우리 사용자인지 검증하는 함수),,
